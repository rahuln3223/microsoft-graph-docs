...
<!-- { "blockType": "permissions", "name": "intune_shared_windowsautopilotdeploymentprofile_haspayloadlinks" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-shared-windowsautopilotdeploymentprofile-haspayloadlinks-permissions.md)]
