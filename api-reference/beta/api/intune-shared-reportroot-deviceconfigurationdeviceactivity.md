...
<!-- { "blockType": "permissions", "name": "intune_shared_reportroot_deviceconfigurationdeviceactivity" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-shared-reportroot-deviceconfigurationdeviceactivity-permissions.md)]
