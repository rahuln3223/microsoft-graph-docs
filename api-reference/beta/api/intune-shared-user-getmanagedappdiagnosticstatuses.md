...
<!-- { "blockType": "permissions", "name": "intune_shared_user_getmanagedappdiagnosticstatuses" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-shared-user-getmanagedappdiagnosticstatuses-permissions.md)]
