...
<!-- { "blockType": "permissions", "name": "intune_shared_user_wipemanagedappregistrationbydevicetag" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-shared-user-wipemanagedappregistrationbydevicetag-permissions.md)]
