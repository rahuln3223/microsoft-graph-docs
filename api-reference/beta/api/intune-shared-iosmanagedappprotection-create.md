...
<!-- { "blockType": "permissions", "name": "intune_shared_iosmanagedappprotection_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-shared-iosmanagedappprotection-create-permissions.md)]
