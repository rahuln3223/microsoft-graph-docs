...
<!-- { "blockType": "permissions", "name": "intune_shared_windowsautopilotdeploymentprofile_assign" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-shared-windowsautopilotdeploymentprofile-assign-permissions.md)]
