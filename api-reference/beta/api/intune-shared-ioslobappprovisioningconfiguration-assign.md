...
<!-- { "blockType": "permissions", "name": "intune_shared_ioslobappprovisioningconfiguration_assign" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-shared-ioslobappprovisioningconfiguration-assign-permissions.md)]
