...
<!-- { "blockType": "permissions", "name": "intune_shared_mobileapptroubleshootingevent_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-shared-mobileapptroubleshootingevent-create-permissions.md)]
