...
<!-- { "blockType": "permissions", "name": "intune_shared_androidmanagedappprotection_delete" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-shared-androidmanagedappprotection-delete-permissions.md)]
