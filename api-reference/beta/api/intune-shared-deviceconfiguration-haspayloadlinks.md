...
<!-- { "blockType": "permissions", "name": "intune_shared_deviceconfiguration_haspayloadlinks" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-shared-deviceconfiguration-haspayloadlinks-permissions.md)]
