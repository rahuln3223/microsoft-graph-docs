...
<!-- { "blockType": "permissions", "name": "intune_shared_devicecompliancepolicy_scheduleactionsforrules" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-shared-devicecompliancepolicy-scheduleactionsforrules-permissions.md)]
