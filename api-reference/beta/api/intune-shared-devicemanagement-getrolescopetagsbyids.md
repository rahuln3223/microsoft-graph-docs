...
<!-- { "blockType": "permissions", "name": "intune_shared_devicemanagement_getrolescopetagsbyids" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-shared-devicemanagement-getrolescopetagsbyids-permissions.md)]
