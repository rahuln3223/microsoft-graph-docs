...
<!-- { "blockType": "permissions", "name": "intune_shared_targetedmanagedappconfiguration_targetapps" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-shared-targetedmanagedappconfiguration-targetapps-permissions.md)]
