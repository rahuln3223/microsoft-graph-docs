...
<!-- { "blockType": "permissions", "name": "intune_shared_targetedmanagedappconfiguration_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-shared-targetedmanagedappconfiguration-update-permissions.md)]
