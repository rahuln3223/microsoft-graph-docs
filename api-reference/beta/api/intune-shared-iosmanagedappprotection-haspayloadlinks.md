...
<!-- { "blockType": "permissions", "name": "intune_shared_iosmanagedappprotection_haspayloadlinks" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-shared-iosmanagedappprotection-haspayloadlinks-permissions.md)]
