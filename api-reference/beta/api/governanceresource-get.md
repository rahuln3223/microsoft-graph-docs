...
<!-- { "blockType": "permissions", "name": "governanceresource_get_2" } -->
[!INCLUDE [permissions-table](../includes/permissions/governanceresource-get-2-permissions.md)]

### Groups

<!-- { "blockType": "permissions", "name": "governanceresource_get_3" } -->
[!INCLUDE [permissions-table](../includes/permissions/governanceresource-get-3-permissions.md)]
