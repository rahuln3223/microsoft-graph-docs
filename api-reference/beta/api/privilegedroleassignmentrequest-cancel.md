...
<!-- { "blockType": "permissions", "name": "privilegedroleassignmentrequest_cancel" } -->
[!INCLUDE [permissions-table](../includes/permissions/privilegedroleassignmentrequest-cancel-permissions.md)]
