...
<!-- { "blockType": "permissions", "name": "intune_shared_deviceenrollmentconfiguration_haspayloadlinks" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-shared-deviceenrollmentconfiguration-haspayloadlinks-permissions.md)]
