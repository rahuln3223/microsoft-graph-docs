...
<!-- { "blockType": "permissions", "name": "intune_shared_mobileapptroubleshootingevent_delete" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-shared-mobileapptroubleshootingevent-delete-permissions.md)]
