...
<!-- { "blockType": "permissions", "name": "intune_shared_ioslobappprovisioningconfiguration_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-shared-ioslobappprovisioningconfiguration-update-permissions.md)]
