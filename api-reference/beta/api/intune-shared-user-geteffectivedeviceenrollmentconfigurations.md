...
<!-- { "blockType": "permissions", "name": "intune_shared_user_geteffectivedeviceenrollmentconfigurations" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-shared-user-geteffectivedeviceenrollmentconfigurations-permissions.md)]
## HTTP Request
