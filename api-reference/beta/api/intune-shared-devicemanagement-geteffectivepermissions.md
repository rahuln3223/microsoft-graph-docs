...
<!-- { "blockType": "permissions", "name": "intune_shared_devicemanagement_geteffectivepermissions" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-shared-devicemanagement-geteffectivepermissions-permissions.md)]
