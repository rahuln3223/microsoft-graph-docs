...
<!-- { "blockType": "permissions", "name": "intune_shared_targetedmanagedappconfiguration_haspayloadlinks" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-shared-targetedmanagedappconfiguration-haspayloadlinks-permissions.md)]
