...
<!-- { "blockType": "permissions", "name": "attacksimulationroot_create_simulation" } -->
[!INCLUDE [permissions-table](../includes/permissions/attacksimulationroot-create-simulation-permissions.md)]
