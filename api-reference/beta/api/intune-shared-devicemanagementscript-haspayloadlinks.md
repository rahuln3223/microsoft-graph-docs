...
<!-- { "blockType": "permissions", "name": "intune_shared_devicemanagementscript_haspayloadlinks" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-shared-devicemanagementscript-haspayloadlinks-permissions.md)]
