...
<!-- { "blockType": "permissions", "name": "intune_cirrus_officeclientconfigurationassignment_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-cirrus-officeclientconfigurationassignment-update-permissions.md)]
