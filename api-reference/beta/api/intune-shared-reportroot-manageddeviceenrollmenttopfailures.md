...
<!-- { "blockType": "permissions", "name": "intune_shared_reportroot_manageddeviceenrollmenttopfailures" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-shared-reportroot-manageddeviceenrollmenttopfailures-permissions.md)]
