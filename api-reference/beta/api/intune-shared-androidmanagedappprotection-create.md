...
<!-- { "blockType": "permissions", "name": "intune_shared_androidmanagedappprotection_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-shared-androidmanagedappprotection-create-permissions.md)]
