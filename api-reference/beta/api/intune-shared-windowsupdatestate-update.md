...
<!-- { "blockType": "permissions", "name": "intune_shared_windowsupdatestate_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-shared-windowsupdatestate-update-permissions.md)]
