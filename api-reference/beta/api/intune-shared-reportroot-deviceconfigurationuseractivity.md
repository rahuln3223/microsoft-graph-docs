...
<!-- { "blockType": "permissions", "name": "intune_shared_reportroot_deviceconfigurationuseractivity" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-shared-reportroot-deviceconfigurationuseractivity-permissions.md)]
