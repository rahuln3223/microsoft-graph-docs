...
<!-- { "blockType": "permissions", "name": "attacksimulationroot_get_simulationautomations" } -->
[!INCLUDE [permissions-table](../includes/permissions/attacksimulationroot-get-simulationautomations-permissions.md)]
