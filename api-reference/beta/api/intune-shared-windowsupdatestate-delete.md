...
<!-- { "blockType": "permissions", "name": "intune_shared_windowsupdatestate_delete" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-shared-windowsupdatestate-delete-permissions.md)]
