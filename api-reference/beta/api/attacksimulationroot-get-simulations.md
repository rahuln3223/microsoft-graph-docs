...
<!-- { "blockType": "permissions", "name": "attacksimulationroot_get_simulations" } -->
[!INCLUDE [permissions-table](../includes/permissions/attacksimulationroot-get-simulations-permissions.md)]
