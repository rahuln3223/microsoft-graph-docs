...
<!-- { "blockType": "permissions", "name": "intune_shared_targetedmanagedappconfiguration_list" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-shared-targetedmanagedappconfiguration-list-permissions.md)]
