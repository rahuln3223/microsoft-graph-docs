...
<!-- { "blockType": "permissions", "name": "intune_shared_mdmwindowsinformationprotectionpolicy_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-shared-mdmwindowsinformationprotectionpolicy-create-permissions.md)]
