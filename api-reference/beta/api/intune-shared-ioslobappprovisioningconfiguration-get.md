...
<!-- { "blockType": "permissions", "name": "intune_shared_ioslobappprovisioningconfiguration_get" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-shared-ioslobappprovisioningconfiguration-get-permissions.md)]
