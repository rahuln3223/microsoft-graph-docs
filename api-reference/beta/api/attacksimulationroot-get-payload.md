...
<!-- { "blockType": "permissions", "name": "attacksimulationroot_get_payload" } -->
[!INCLUDE [permissions-table](../includes/permissions/attacksimulationroot-get-payload-permissions.md)]
