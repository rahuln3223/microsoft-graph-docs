...
<!-- { "blockType": "permissions", "name": "intune_shared_targetedmanagedappconfiguration_create" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-shared-targetedmanagedappconfiguration-create-permissions.md)]
