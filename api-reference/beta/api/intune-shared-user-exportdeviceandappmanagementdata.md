...
<!-- { "blockType": "permissions", "name": "intune_shared_user_exportdeviceandappmanagementdata" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-shared-user-exportdeviceandappmanagementdata-permissions.md)]
