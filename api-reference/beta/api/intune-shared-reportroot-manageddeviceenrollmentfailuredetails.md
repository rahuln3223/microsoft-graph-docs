...
<!-- { "blockType": "permissions", "name": "intune_shared_reportroot_manageddeviceenrollmentfailuredetails" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-shared-reportroot-manageddeviceenrollmentfailuredetails-permissions.md)]
