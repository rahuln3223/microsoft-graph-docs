...
<!-- { "blockType": "permissions", "name": "intune_shared_mdmwindowsinformationprotectionpolicy_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-shared-mdmwindowsinformationprotectionpolicy-update-permissions.md)]
