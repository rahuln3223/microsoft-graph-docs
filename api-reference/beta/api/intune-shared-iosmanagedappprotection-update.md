...
<!-- { "blockType": "permissions", "name": "intune_shared_iosmanagedappprotection_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-shared-iosmanagedappprotection-update-permissions.md)]
