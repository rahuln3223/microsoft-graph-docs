...
<!-- { "blockType": "permissions", "name": "intune_shared_androidmanagedappprotection_haspayloadlinks" } -->
[!INCLUDE [permissions-table](../includes/permissions/intune-shared-androidmanagedappprotection-haspayloadlinks-permissions.md)]
