...
<!-- { "blockType": "permissions", "name": "directory_deleteditems_delete_2" } -->
[!INCLUDE [permissions-table](../includes/permissions/directory-deleteditems-delete-2-permissions.md)]

The signed-in user needs to have one of the following roles: *Global Administrator* or *User Administrator*.

### For groups:

<!-- { "blockType": "permissions", "name": "directory_deleteditems_delete_3" } -->
[!INCLUDE [permissions-table](../includes/permissions/directory-deleteditems-delete-3-permissions.md)]
